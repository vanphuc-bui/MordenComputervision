...
Có một số kiến trúc ANN tiêu chuẩn, định lý xấp xỉ phổ quát nói rằng chúng ta luôn có thể tìm thấy một kiến trúc mạng nơ-ron đủ lớn với tập trọng số phù hợp để có thể dự đoán chính xác bất kỳ đầu ra nào cho bất kỳ đầu vào nào. Điều này có nghĩa là, đối với một tập dữ liệu/tác vụ nhất định, chúng ta có thể tạo một kiến trúc và tiếp tục điều chỉnh trọng số của nó cho đến khi ANN dự đoán những gì chúng ta muốn nó dự đoán. Việc điều chỉnh các trọng số cho đến khi điều này xảy ra được gọi là huấn luyện mạng thần kinh.

Trong chương này, chúng ta sẽ tạo một kiến trúc rất đơn giản trên một tập dữ liệu đơn giản và chủ yếu tập trung vào cách các khối xây dựng khác nhau (feedforward, backpropagation, learning rate) của ANN giúp điều chỉnh trọng số để mạng học cách dự đoán kết quả đầu ra mong đợi từ các đầu vào đã cho. Trước tiên, chúng ta sẽ tìm hiểu về mặt toán học mạng nơ-ron là gì, sau đó xây dựng một mạng từ đầu để có một nền tảng vững chắc. Sau đó, chúng ta sẽ tìm hiểu về từng thành phần chịu trách nhiệm huấn luyện mạng nơ-ron và viết code cho chúng. Chúng ta sẽ đề cập đến các chủ đề sau:
...
<p align="center">
<img src="https://github.com/vanphuc-bui/MordenComputervision/blob/main/images/Chapter01/dog.png" style="width:50%; border:0;">
</p>
